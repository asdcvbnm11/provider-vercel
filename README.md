...
一个可以将 Clash 订阅转换成 Proxy Provider 和 External Group(Surge) 的工具[^1]
...
[^1]: forked from [qier222/proxy-provider-converter](https://github.com/qier222/proxy-provider-converter)